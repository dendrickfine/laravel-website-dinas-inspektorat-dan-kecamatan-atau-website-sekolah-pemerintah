...
<div class="card mb-3 mt-3" data-aos="fade-up" style="border-radius:20px; background-color:#779eb2; margin-left:15px; margin-right:15px; box-shadow: 4px 8px 20px 5px rgba(173, 216, 230, 0.9);">
  <div class="row no-gutters align-items-center">
    <div class="col-md-5 text-center mt-4">
      @if ($ketua && $ketua->gambar_playlist)
        <img src="{{ asset('uploads/' . $ketua->gambar_playlist) }}" class="card-img" alt="{{ $ketua->slug }}" style="height: auto; width: 350px; ">
      @else
        <img src="{{ asset('back/img/bandung.png') }}" class="card-img" alt="default" style="height: auto; width: 100px;">
      @endif
      <h2 class="card-title" data-aos="fade-up" style="font-family: 'Marcellus', serif; ; margin-top: 10px; color:#fff;">
        {{ $ketua && $ketua->judul_playlist ? $ketua->judul_playlist : 'Belum Ada Ketua' }}
      </h2>
    </div>
    <div class="col-md-6">
      <div class="card-body text-justify" data-aos="fade-left">
        <h2 class="card-text" style="font-family: 'Lobster Two',sans-serif; color:#fff;">
...
<div class="row mt-3" style="background-color:#f1f1f1;">
                    ...
                    <h2 style="font-family: 'Marcellus', serif;" class="heading-section mt-4 pb-md-4"><i class="fa-solid fa-photo-film"></i> GALERI FOTO</h2>
					</div>
					<div class="col-md-12">
            ...
            @if($iklanA->count() > 0)
                @foreach ($iklanA as $iklan)
                    <div class="item" data-aos="flip-left">
                        <div class="work">
                            <div class="img d-flex align-items-center justify-content-center rounded" style="background-color:#f1f1f1; background-image: url('{{ asset('uploads/' . $iklan->gambar_iklan) }}');">
                                <a href="{{ $iklan->link }}" target="_blank"class="icon d-flex align-items-center justify-content-center">
                                    <span class="fas fa-arrow-right"></span>
                                </a>
                            </div>
                            <div class="text pt-3 w-100 text-center">
                                <h3 style="font-family: 'Abel', sans-serif;">{{ $iklan->judul }}</h3>
                            </div>
                        </div>
                    </div>
                @endforeach
...
<div id="result" class="container mt-2">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body" style="font-family: 'Abel', sans-serif;">
                        <div class="row">
                            ...
                            <a href="{{ route('detail-artikel', $row->slug) }}">
                                <img src="{{ asset('uploads/' . $row->gambar_artikel) }}" class="card-img-top img-fluid" 
                                style="width: 800px; height: 205px; object-fit: cover; border-radius: 15px;" alt="{{ $row->judul }}">
                            </a>
                            </div>
                            <div class="col-md-8">
                                <small><i class="far fa-calendar-days"></i> {{ $row->created_at->format('d F Y') }}</small>
                                <h4 class="card-title" style="font-family: 'Abel', sans-serif;margin-top: 5px; margin-bottom: 5px;">
                                    <a href="{{ route('detail-artikel', $row->slug) }}" style=" font-size:20px; color: #1e2c4d; font-weight: bold;">
                                        {{ $row->judul }}
                                    </a>
                                </h4>
            ...
            <div class="row justify-content-start" style="font-family: 'Abel', sans-serif;">
                <!-- Menggunakan col-lg-5 untuk memberikan ruang yang lebih besar pada layar besar -->
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="card shadow-sm" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center">
                            <img src="{{ asset('uploads/lapor1.png') }}" style="width: 100%; height: auto; border-radius: 15px;">
                ...
                <div class="col-md-6 col-lg-6 mb-4">
                    <div class="card shadow-sm" style="border-radius: 15px;">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <a href="#" class="card-title mt-3" style="text-decoration: underline; color:#1e2c4d;" id="details-link-2">Details</a>
            ...
            <div class="detail-sidebar-terbaru">
                ...
                <div style="margin-bottom: 20px;">
                    <a href="https://www.kemdikbud.go.id/" target="_blank">
                        <img src="{{ asset('uploads/kemendikbud.png') }}" alt="badan pemeriksa keuangan" style="width: auto; height: 210px;">
                    </a>
                </div>
                </div>
                <hr>
                <h4 style="font-family: 'Marcellus', serif;"><i class="fa-solid fa-file-lines"></i> ARSIP</h4>
                <hr>
                ...
                <img src="{{ asset('uploads/' . $row->gambar_artikel) }}" style="width: 90px; height: 80px; object-fit: cover; border-radius: 10px;" class="card-img-top img-fluid mr-3 mt-2" alt="{{ $row->judul }}">
                    <div class="media-body" style="font-family: 'Abel', sans-serif;">
                        <small><i class="far fa-calendar-days"></i> {{ $row->created_at->format('d F Y') }}</small>
                        <div class="mt-0">
